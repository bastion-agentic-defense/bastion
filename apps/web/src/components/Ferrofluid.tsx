...
const Ferrofluid = ({
  ...
  useEffect(() => {
    ...
    const uniforms = {
      ...
      uMouseEnabled: { value: mouseInteraction && !reduce ? 1 : 0 },
    ...
    if (mouseInteraction && !reduce) {
      canvas.addEventListener('pointermove', onPointerMove);
    }

    if (reduce) {
      uniforms.iTime.value = 12;
    ...
    return () => {
      ...
      if (mouseInteraction && !reduce) canvas.removeEventListener('pointermove', onPointerMove);
      ro.disconnect();
