...
- Disambiguating **compliance** and **financial crime** terms in reports, tickets, or training.  
- Cross-checking labels before citing **FATF** concepts next to **on-chain** or **screening** workflows.  
- Avoiding ad-hoc definitions when a **standard international** term exists.

## How to use with blockint

| Need | Skill |
|------|--------|
| Ethics, reporting posture, crime taxonomy (investigations) | **crypto-investigation-compliance** |
| Screening workflow vocabulary (address/tx, indicators) | **risk-exposure-screening-concepts**, **address-screening-workflow-concepts**, **transaction-screening-workflow-concepts** |
| Sanctions API / vendor tooling (operational) | **chainalysis-sanctions-screening** |
| Analytics platforms (vendor-neutral) | **blockchain-analytics-operations** |
