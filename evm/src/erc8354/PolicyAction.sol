...
library PolicyActionLib {
    ...
    function commit(
        ...
        return keccak256(
            abi.encode(
                a.chainId, a.domainId, a.agentId, a.target, a.value, a.callDataHash, a.actionNonce
            )
        );
    }
}
