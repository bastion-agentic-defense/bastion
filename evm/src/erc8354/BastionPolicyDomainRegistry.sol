...
/// @dev Conforming Bastion implementation of the ERC-8354 RECOMMENDED companion interface.
contract BastionPolicyDomainRegistry is IPolicyDomainRegistry {
    struct RootEntry {
        bytes32 root;
        uint64 version;
        uint64 updatedAt;
    ...
    function currentRoot(
        bytes32 domainId
    ) external view returns (bytes32, uint64, uint64) {
